...
ZNSP::ZNSP(QSettings *config, QObject *parent) : Adapter(config, parent)
{
    m_sequenceId = -1;
...
bool ZNSP::unicastRequest(quint8, quint16 networkAddress, quint8 srcEndPointId, quint8 dstEndPointId, quint16 clusterId, const QByteArray &payload)
{
...
bool ZNSP::multicastRequest(quint8, quint16 groupId, quint8 srcEndPointId, quint8 dstEndPointId, quint16 clusterId, const QByteArray &payload)
{
    apsDataRequestStruct request;
    QByteArray buffer;
...
bool ZNSP::zdoRequest(quint8, quint16 networkAddress, quint16 clusterId, const QByteArray &data)
{
    // quint16 command;
...
bool ZNSP::bindRequest(quint8, quint16 networkAddress, quint8 endpointId, quint16 clusterId, const QByteArray &address, quint8 dstEndpointId, bool unbind)
{
...
bool ZNSP::leaveRequest(quint8, quint16 networkAddress)
{
...
bool ZNSP::lqiRequest(quint8, quint16 networkAddress, quint8 index)
{
...
void ZNSP::parsePacket(quint16 flags, quint16 command, const QByteArray &data)
{
    if (m_adapterDebug)
    ...
    switch (qFromBigEndian(command))
    {
        ...
        default:
        {
            ...
            {
                if ((m_sequenceId == static_cast <quint8> (data.at(0))))
                {
...
bool ZNSP::startCoordinator(void)
{
